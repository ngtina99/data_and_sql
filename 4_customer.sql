...
from customer
where customer_id = (select phone_number_customer_id from phone_number p where p.phone_number = '555-3344');

select c.customer_id, c.first_name, p.phone_number
from customer c
